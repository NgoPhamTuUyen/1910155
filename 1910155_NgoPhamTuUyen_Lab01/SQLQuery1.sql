...
INSERT [dbo].[Bills] ([ID], [Name], [TableID], [Amount], [Disscount], [Tax], [Status], [CheckoutDate], [Account]) VALUES (1, N'Hóa đơn thanh toán', 5, 150000, 0.05, 0, 1, NULL, N'tdquy')
...
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (1, N'Rau muống xào tỏi', N'Đĩa', 6, 20000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (2, N'Cơm chiên Dương châu', N'Đĩa nhỏ', 4, 35000, N'3 người ăn')
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (3, N'Cơm chiên Dương châu', N'Đĩa lớn', 4, 40000, N'4 người ăn')
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (4, N'Ếch thui rơm', N'Đĩa', 2, 70000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (5, N'Sò lông nướng mỡ hành', N'Đĩa', 2, 80000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (6, N'Càng cua hấp', N'Đĩa', 2, 100000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (7, N'Canh cải', N'Tô', 8, 20000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (8, N'Gà nướng muối ớt', N'Con', 3, 180000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (9, N'Bia 333', N'Chai', 10, 12000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (10, N'Bia Heniken', N'Chai', 10, 20000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (11, N'Súp cua', N'Tô', 1, 15000, NULL)
INSERT [dbo].[Food] ([ID], [Name], [Unit], [FoodCategogyID], [Price], [Notes]) VALUES (12, N'Thịt kho', N'Đĩa', 5, 25000, N'Theo thời giá')
...
@Notes nvarchar(3000)
AS
	INSERT INTO Food (Name, Unit, FoodCategogyID, Price,  Notes)
...
----/*Câu 2:Viết một thủ tục _GetAll để lấy dữ liệu của tất cả các bảng, truyền vào tên bảng. */
...
Begin
 ...
 EXEC (@sql)
END
EXEC [dbo].[GetAll] 'Account'
EXEC [dbo].[GetAll] 'BillDetails'
EXEC [dbo].[GetAll] 'Bills'
EXEC [dbo].[GetAll] 'Category'
EXEC [dbo].[GetAll] 'Role'
EXEC [dbo].[GetAll] 'Food'
EXEC [dbo].[GetAll] 'RoleAccount'
EXEC [dbo].[GetAll] 'Table'

---/*Câu 3: Viết một thủ tục _GetByID để lấy dữ liệu của tất cả các bảng có ID là kiểu int, khóa chính và tự tăng. Tham số truyền vào ID và tên bảng.*/
Create procedure [_GetByID_]_ @ID_ int
as
 begin
 select * from dbo.Account, dbo.BillDetails, dbo.Bills, dbo.Category, dbo.Food, dbo.Role, dbo.RoleAccount
 end
 go